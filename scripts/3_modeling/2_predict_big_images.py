    ...
    def __generate_prediction_tiles(self, network):
        ...
        for y in tqdm(range(0, int(self.n_chunks_y))):  
            ...
            for x in range(0, int(self.n_chunks_x)):  
                ...
                image_array  = torch.Tensor(image_array[:-2,:,:])
...
if __name__ == '__main__':
    ...
    image_path_base  = 'E:\\glacier_data\\tiff\\'
    output_dir = 'E:\\glacier_data\\predictions\\'
    chunk_size = 1024 + 512 
...
#    net = UNets.AttU_Net(10, 2)
    ...
    for i, file in enumerate(files):
        ...
        # Create the objects
        processor = ProcessBigImages(file, output_dir, output_name, chunk_size)
